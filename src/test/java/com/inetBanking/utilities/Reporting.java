...
public class Reporting extends TestListenerAdapter {
	...
	public void onStart(ITestContext testContext) {
		...
		htmlReporter = new ExtentHtmlReporter(System.getProperty("D:\\java chinmay\\iNetBankingV3"+"/test-output/"+repName));//specify location
		htmlReporter.loadXMLConfig(System.getProperty("D:\\java chinmay\\iNetBankingV3\\extent_config.xml"));
		...
		extent.setSystemInfo("user","Chinmay");
